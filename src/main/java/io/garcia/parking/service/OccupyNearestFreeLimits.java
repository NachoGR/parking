 ...
 */
@Component
public class OccupyNearestFreeLimits implements IParking{

    @Override
    public boolean getCarSize(int sizeCar) {
        return true;
    }

    @Override
    public int getMinimunLevels() {
        return 1;
    }

    @Override
    public int getMinimunLines() {
        return 1;
    }

    @Override
    public int getMinimunMeters() {
        return 1;
    }
